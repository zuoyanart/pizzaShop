define('shopadmin/pinpai/pinpai', function(require, exports, module) {
  ...
  with (locals || {}) { (function(){ 
   buf.push('');__stack.lineno=1;for(var i=0,ll=data.length; i<ll; i++) { ; buf.push('\n  <li>\n    <label class="checkgroup">\n      <input type="checkbox" id="pinpai_', escape((__stack.lineno=4,  data[i].id)), '" name="checkall"><label for="pinpai_', escape((__stack.lineno=4,  data[i].id)), '" class="check-all"></label>\n    </label>\n    <a href="', escape((__stack.lineno=6,  data[i].link)), '" target="_blank">', escape((__stack.lineno=6,  data[i].title)), '</a>\n    <span><a href="./pinpai/edit?id=', escape((__stack.lineno=7,  data[i].id)), '">编辑</a><i class="remove">删除</i></span>\n  </li>\n');__stack.lineno=9;}; buf.push('\n'); })();
  } 
  return buf.join('');
  } catch (err) {
