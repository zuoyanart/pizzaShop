...
window.layer = {
    ...
    config: function(options, fn){
        ...
        layer.use('/static/modules/layer/skin/layer.css'.replace('/modules/layer/',''), (options.extend && options.extend.length > 0) ? (function loop(){
...
'function' === typeof define == false ? define(function(){
   ...
   layer.use('/static/modules/layer/skin/layer.css'.replace('/modules/layer/',''));
}();
