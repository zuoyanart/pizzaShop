...
window.layer = {
    ...
    config: function(options, fn){
        ...
        layer.use(__uri('/modules/layer/skin/layer.css').replace('/modules/layer/',''), (options.extend && options.extend.length > 0) ? (function loop(){
...
'function' === typeof define == false ? define(function(){
   ...
   layer.use(__uri('/modules/layer/skin/layer.css').replace('/modules/layer/',''));
}();
